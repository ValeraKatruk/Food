...
function cards() {
  ...
  class MenuCard {
    constructor(src, alt, title, descr, price, parentCard) {
      this.src = src, this.alt = alt, this.title = title, this.descr = descr, this.price = price, this.parent = document.querySelector(parentCard), this.transfer = 80, this.changeToRub();
    }
    changeToRub() {
...
function createForms(formSelector, timerShowModal) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", event => {
      ...
      (0,_modules_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)("http://localhost:3000/requests", json).then(data => {
...
/* harmony default export */ __webpack_exports__["default"] = (createForms);
...
function slider(_ref) {
  ...
  function currentSlide(n) {
    n < 10 ? current.innerHTML = `0${slideCount}` : current.innerHTML = slideCount;
    doters.forEach(dot => {
...
function tabs(tabsSelector, tabsContantSelector, tabsParentSelector, activeClass) {
  ...
  function showTabsContent() {
    let numTab = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
...
/* harmony default export */ __webpack_exports__["default"] = (timerModal);
